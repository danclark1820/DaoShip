...
class ReplayScene: SKScene {
    ...
    let notes = [
        ...
        "Those who know, do not talk, those who talk, do not know. Close your mouth, disregard your judgements, forget about your rules for living, withhold your reaction, do not stare is dissaproval. This is how to be one with the way.",
