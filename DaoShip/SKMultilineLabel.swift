...
//    var alpha:CGFloat {didSet {update()}}
    ...
    init(text:String, labelWidth:Int, pos:CGPoint, name:String, fontName:String="Palatino-Roman",fontSize:CGFloat=26,fontColor:UIColor = UIColor(red: 1.00, green: 0.96, blue: 0.57, alpha: 1.0),leading:Int=11, alignment:SKLabelHorizontalAlignmentMode = .Center, alpha:CGFloat=1.0, shouldShowBorder:Bool = false, _ coder: NSCoder? = nil) {
