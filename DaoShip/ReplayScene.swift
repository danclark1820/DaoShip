...
class ReplayScene: SKScene {
    ...
    let notes: [String] = [
        ...
        "If leading the crew in this fashion still does not keep the peace, hold on to simplicity, act for the crew, decrease selfish desires, and let ship take its course.",
        "Give up thinking and end your confusion and distress. What is the difference between prosperity and poverty? What is the difference bewtween true and false. There is no need to live in the shadow of others desires. There is no reason to fear what others fear.",
        ...
        "How can the master pilots follow the ships way if it is not physical thing? Because they do not look for it or try to hold it, they listen to there intuition and move on.",
        "How can the master pilots use their intuition to follow something so confusing when explained with words whose depths are unknown? Because they let there intuition do the work and do not overthink  future outcomes.",
        ...
        "The fill something up it must be empty first. To straighten something out it must be bent first. To make something soft it must be stiff first. Many desires will be hard to fulfill. Fewer the desires, the easier they are to fulfill.",
        "A master is always humble. A master spreads humbleness. Because they do not brag, they are viewed as accomplished. Have nothing to brag about, people believe everything they say. Because they are not exactly sure who they are, others can relate to them on the deepest level.",
        ...
        "Standing on tiptoes we become un-sturdy. Outstretched arms cannot hold something up for long. Bragging and boasting only shows what you are lacking. Letting titles define you, you cannot know who you really are. If you want to be one with the ship, just help your crew, then step back.",
        ...
        "The way is a part of all things, physical and non-physical. It is in the walls as well as the empty space that allow us to call it a room. There at the begining when the universe was smaller then a speck of dust, it spreads out with the universe as it expands.",
        ...
        "A good pilot has no fixed route. A good mechanic does not assume she knows what wrong with the engine. A good ship designer lets the present state of ships guide his next design.",
        "The master pilot can and will discuss the ship with anyone who asks, ship lovers and anti ship building people.  He is always ready challenges the ship and future missions present. By being this way, the pilot embodies the way of the ship.",
        ...
        "Understanding the light but keeping to the dark, The pilot is a role model for future pilots. Being a role model the for future pilots, the way of the ship always creates virtue within the pilot.",
        "The ship is formed from metal parts. And the metal parts are formed from a mere metal block. Understanding the parts remembering they came from blocks the pilot understands the ship. The master pilot knowing this, can help all in there journey to understand the ship.",
        "Trying to control the universe will only end in failure. It is not an object to be held or molded.",
        "It is the way of the universe that what is ahead will be behind, what is hot, will cool down,  what is strong, eventually weakens. The master pilot sees the ship and the universe for how it is and does not try to control it. The master lets them go there way and does not over exert himself.",
        "The master pilot relies on the way of the ship for leading his crew does not fight with his men, or capture enemies by way of force. Every action creates an equal and opposite reaction. Force, even for good, will always come back to the master or his crew.",
        "The master pilot does her work then rests. The master knows the universe is beyond a pilots control, and forcing events will lead to failure.",
        ...
        "The master pilot avoids the use of weapons at all costs. When it does become an absolute necessity, the weapons are used with heavy hearts, and utter respect for there destructiveness. The master does not celebrate victory because pilots on both sides have fallen.",
        ...
        "The way of the ship is a name for something that cannot be named. If leaders of our galaxies are at one with the way of the ship, there would be intergalactic peace. There would be no need for laws becuase people would act based on good natured intuition.",
        "What part of the ship is ship? Is the engine the ship, is the cockpit the ship? When we have names for things, understand that names are just that. Understand what is underneath the name and its purpose. Understand where the name ends.",
        "The pilot who knows other people is compassionate. The pilot who knows herself is wise.  Being able to help others is couragous.  Being able to help oneself is a daily battle that can end in daily victory.",
        ...
        "The way of the ship flows in all ships and pilots. All ships were created from it, yet it does not claim the ships as a possesion. It is visible in the smallest nut or bolt of the ship, in there interlocking perfection, but it is also in the whole ship, when it takes graceful flight.",
        "Becuase the way is in the little nuts and bolts and a graceful flight, the master pilot pays just as much attention too the small things as the great things. Great acheivment comes from the pilots ability to focus on small not great acheivements that are built upon daily.",
        ...
        "The way of the ship is never doing anything, yet through it the ship endures.  If leaders could center themselves in the way of the ship the whole universe would be transformed. Through simplicity, non-desire, stillness, the universe corrects itself.",
        "Master pilots do not try to control, hence they are always in control. The average person always trying to control feels helplessly out of control. The master pilot does plan, yet everything is done in time. The average person always planning, never gets things done in time.",
        ...
        "When the way of the ship is gone, the men make plans, when the plans are lost, morality kicks in, when morality is lost, justice must be served, when justice is served, there is violence. Hence, the master focuses solely on the reality of a present scenario, and not the dogma of old words and rules.",
        ...
        "Returning is the movement of the way. Things done over time through soft action are the markings of the way of the ship at work. All objects are created into being. Being is created from non-being.",
        ...
        "The way of the ship created the one. One created Two. Two created Three. Three created all things. All things come from the many and move towards embracing the way of the ship. When the many things combine to be one with the way of the ship, there is peace.",
        ...
        "The less things are are forced, the easier they fit into place. The less we force knowledge into our brain, the easier it is to remember, because we learn it is in the way of things, right in front of our eyes, and does not need to be remembered or learned.",
        "The master pilot has no mind of their own. The master pilot takes the mind of the people. The master pilot is good to those who are good, and good to those who are not good. The master pilot is honest with those who are honest, and with those who are not honest.",
        "The master pilots mind is a reflection of the universe. The people seek the master pilot with attentive ears and eyes, and the master pilot cares for them like they were her own children.",
        ...
        "Being one with the way of the ship knowing that death and old age are part of a reality we all must face, the master pilot does not worry about death, or getting things done. They go on acting daily, with actions that come naturally from their intuition.",
        ...
        "For the first organisms, we beleive their observable universe was a warm puddle. They flew around their universe without a cause with the grace and comfort of the best cruiser, at speeds our best racers cannot rival.",
        ...
        "The way of the ship is easy to follow, yet people still find themselves on the side paths. When the rich over indulge, while the poor struggle to find food and water; When the government builds weapons over hospitals in times of peace, this is not the way of the ship.",
        ...
        "When the way of the ship is present in your day to day, your actions will be true. When the way of ship is present in your family, the family will grow in size and love for one another. When it is present in the galaxy, others galaxies follow suit.",
        "How do we know letting the way of the ship be present has these amazing results? Because we let it everyday when a new baby is born, when child learns to fly, when the earth makes a trip around the sun, or when the stars come out at night. The way of the ship presents its great feats daily.",
        ...
        "Newborns can cry the whole day without losing there voice. This is because newborns know the harmony of there body without knowing. Knowing harmony is stability. Stability brings clarity of mind.",
        ...
        "Those who know, do not talk, those who talk, do not know. Close your mouth, disregard your judgements, forget about your rules for living, withhold your reaction, do not stare in dissapproval. This is how to be one with the way.",
        ...
        "In order for the universe to be governed well its government must learn to step back and let the ship take its course. The universe has been governing itself long before man existed, why should man try to govern man and the universe when the universe will do it for them.",
        ...
        "The master pilot gives up law, and people act with integrity. The master gives up trying to fix the economy, and the people find ways to prosper. The master gives up trying to make the people moral and religious, and they naturally tend toward peace and quiet.",
        "When the master stops forcing things, everything falls into place.",
        "When the universe is governed with a telescope from afar, the people are good. When the universe is governed with a microscope over every action, the people are opressed, and look for loopholes to exploit or secret passageways to escape from sight.",
        ...
        "The master pilot is incorruptible without being disagreeable. The master pilot gets to the point without seeming urgent. The master pilot is like a guiding light, but is not blinding.",
        "Everything in moderation is what the master pilots grandmother always said. And this is true for governing. The moderate governor knows when to stop. Knowing when to stop, the pilot, the governor, the branches of government do not over extend themselves.",
        ...
        "The greatest mother ship was built from nothing but a single plan. The plan for the great mother ship started with a single line on a single document. The mission of thousand light years starts with a single take off.",
        ...
        "When people know that they don’t know all there is to know about the ship and how to fix it, they are free to discover what is truly broken, and what the best solution to fixing it is.",
        "If you want to be a good captain to your crew, stop trying to be brighter then your crew. Being the dumbest crew member, the crew will learn how to operate without you. Knowing how to operate without you, the crew will learn how to rise to the challenge of a dangerous mission or a profoundly damaged ship.",
        ...
        "The master pilot holds three golden treasures, compassion, non-desire for material goods, and non-desire for power. Through compassion for herself and the people, the master understands desire for material goods and power.",
        "Through non-desire for material goods and power, the master achieves an understanding of nature that is unfathomable for those who desire material things. Through this value the master can fly with grace that can only be experienced, not imagined.",
        "The best fighter pilot, having compassion for the enemy, and non desire for power, wants the enemy at their best, for the spirit of competition, not at their weakest for the pettiness of victory. The best pilots do not use anger towards the enemy as a source of strength. The great pilot waits for enemy to advance.",
        ...
        "There is no bigger mistake then underestimating the enemy.  Underestimating the enemy is to forget they are fellow pilots with families at home as well. Underestimating the enemy, through lack of compassion, you forget you three treasures, and you become the evil enemy who has lost there way.",
        ...
        "These words go deeper then a mans existence and can never be fully understood. But, because what they represent was there at human kinds beginning, we can begin to understand them. We do this by not trying to understand them, being honest with ourselves, taking in our surroundings, and following our intuition.",
        ...
        "The way of the ship does not compete but is always winning. It does not speak but always gives the perfect response. It is not called for yet it is always there. Is not rushed but can plan ahead. The mesh of its net is wide but nothing passes through.",
        "Realizing the universe is in constant motion, and that change is in its nature, you can let go of anxiety about change. Realizing that returning to mother universe is as beautiful as being born into it, you realize that there is nothing to fear.",
        ...
        "During life a human is soft and bending. After death, stiff and brittle. This holds true for the branch of a tree as well, alive it is bending and cannot be broken, dead, it is brittle and easy to break.  Soft and bending is a sign of life, and will alway overcome the stiff and brittle.",
        ...
        "Trying to control things and using force to protect ones position in life goes against the way of the ship. Taking from those who do not have enough and giving to those who have to too much is the way of a man who has lost his way.",
        ...
        "Bearing the humiliation of a planet, you are fit to lead it. Taking on the pitfalls of the planet, you become its King. The closer we get to the truth, the more paradoxical it becomes.",
